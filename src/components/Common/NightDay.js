...
import { nightDay } from "../../features/layoutSlice";
...
const NightDay = () => {
  ...
  const changeTheme = () => {
    if (theme === "day") dispatch(nightDay("night"));
    else dispatch(nightDay("day"));
  };

  return (
    <div className="switch_box box_3">
      <div className="toggle_switch">
        <input type="checkbox" className="switch_3" onClick={changeTheme} />
        <svg
          className="checkbox"
